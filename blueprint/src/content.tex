...
\inputleannode{prop:simplex-cat-factorization}
...
\inputleannode{defn:sset-category}

Standard examples of simplicial sets include:

\inputleannode{defn:standard-simplex}

\inputleannode{defn:simplex-boundary}

\inputleannode{defn:simplicial-horn}
...
\inputleannode{lem:simplex-yoneda}
...
\inputleannode{cor:sset-cat-limits}


\inputleannode{cor:sset-cat-colimits}
...
\inputleannode{defn:quasi-category}
  ...
  \inputleannode{defn:kan-complex}
...
\inputleannode{defn:nerve}


\inputleannode{defn:nerve-functor}
 ...
 \inputleannode{prop:nerve-2-coskeletal}
...
This is not the proof that was formalized but we include it for fun:
 ...
 \inputleannode{defn:1-simplex-htpy}
...
\inputleannode{defn:one-truncation}

\inputleannode{prop:free-refl-quiver}


\inputleannode{defn:homotopy-cat}
...
\inputleannode{prop:nerve-reflective}
   ...
   \inputleannode{prop:ho-nerve-adjunction}
   ...
   \inputleannode{prop:nerve-fully-faithful}
...
\section{The homotopy category of a quasi-category, isofibrations, and equivalences}\label{sec:homotopy-category}
   ...
   \inputleannode{defn:2-truncated-qcat}

   \inputleannode{lem:2-truncated-qcat}
...
\inputleannode{lem:2-truncated-qcat-htpy}
...
\inputleannode{lem:2-truncated-qcat-htpy-comp}


\inputleannode{cor:2-truncated-qcat-htpy-comp}


These results now combine to justify the following definition:

\inputleannode{defn:2-truncated-qcat-htpy-cat}
...
In other words, the hom-types are quotients of the hom-types of the underlying reflexive quiver of Definition \ref{defn:one-truncation} of a 2-truncated simplicial set, where the additional quotienting is by the homotopy relation, which is an equivalence relation by Lemma \ref{lem:2-truncated-qcat-htpy}. Composition is defined by (2,1)-horn filling and is well-defined by Lemma \ref{lem:2-truncated-qcat-htpy-comp}.
   ...
   \inputleannode{lem:htpy-cat-of-qcat}


Later we will require either of the following results:

\inputleannode{lem:ho-preserves-finite-products}
...
%   \end{proposition}
 ...
 %  \end{proof}
  ...
  \inputleannode{defn:coherent-isomorphism}
...
\inputleannode{defn:qcat-equivalence}
  ...
  \inputleannode{defn:qcat-trivial-fibration}
...
\inputleannode{defn:simplicial-category}
...
\inputleannode{defn:underlying-cat}
...
\inputleannode{defn:simplicial-cotensor}
...
\inputleannode{defn:simplicial-cotensors}
...
\inputleannode{lem:cotensor-bifunctor}
...
\inputleannode{defn:simplicial-conical-limit}
...
\inputleannode{defn:lax-monoidal-functor}
...
\inputleannode{prop:change-of-base}
...
\inputleannode{cor:free-underlying-2-adj}
